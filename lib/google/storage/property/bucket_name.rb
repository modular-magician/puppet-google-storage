...
module Google
  module Storage
    module Data
      ...
      class BucketNameRefCatalog < BucketNameRef
      ...
      class BucketNameRefApi < BucketNameRef
    ...
    module Property
      ...
      class BucketNameRef < Puppet::Property
        ...
        def self.unsafe_munge(value)
          return if value.nil?
          Data::BucketNameRefCatalog.new(value)
        end
