...
module Google
  module Storage
    module Data
      # A class to manage data for project_team for bucket_access_control.
    ...
    module Property
      # A class to manage input to project_team for bucket_access_control.
      class BuckAcceContProjTeam < Puppet::Property
