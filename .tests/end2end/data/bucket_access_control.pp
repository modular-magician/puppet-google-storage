...
#       puppet apply .tests/end2end/data/bucket_access_control.pp
#
...
gstorage_bucket_access_control { 'puppet-e2e-user-nelsona@google.com':
  bucket     => 'puppet-e2e-puppet-storage-module-test',
