...
describe Puppet::Type.type(:gstorage_default_object_acl).provider(:google) do
  before(:all) do
          ...
          context 'title == name (pass)' do
            ...
            let(:catalog) do
              apply_with_error_check(
                ...
                gstorage_default_object_acl { 'title0':
                  ensure       => present,
                ...
                gstorage_default_object_acl { 'title1':
                  ensure       => present,
                ...
                gstorage_default_object_acl { 'title2':
                  ensure       => present,
            ...
            context 'Gstorage_default_object_acl[title0]' do
              subject do
                catalog.resource('Gstorage_default_object_acl[title0]').provider
              end
            ...
            context 'Gstorage_default_object_acl[title1]' do
              subject do
                catalog.resource('Gstorage_default_object_acl[title1]').provider
              end
            ...
            context 'Gstorage_default_object_acl[title2]' do
              subject do
                catalog.resource('Gstorage_default_object_acl[title2]').provider
              end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gstorage_default_object_acl[title0]').provider.ensure
          end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gstorage_default_object_acl[title0]')
              .provider.ensure
          end
  ...
  context '#flush' do
    subject do
      Puppet::Type.type(:gstorage_default_object_acl).new(
        ensure: :present,
        name: 'my-name'
      ).provider
    end
  ...
  def expand_variables(template, data, extra_data = {})
    Puppet::Type.type(:gstorage_default_object_acl).provider(:google)
