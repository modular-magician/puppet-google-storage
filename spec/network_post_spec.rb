...
describe Google::Storage::Network::Post do
  let(:credential) { TestCred.new }
  let(:uri_in) { Google::Storage::NetworkBlocker::ALLOWED_TEST_URI }
  ...
  context 'successful request' do
    before(:each) do
      Google::Storage::NetworkBlocker.instance.allow_post(
  ...
  context 'failed request' do
    before(:each) { Google::Storage::NetworkBlocker.instance.deny(uri_in) }
